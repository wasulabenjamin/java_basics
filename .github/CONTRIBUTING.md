# Contributing
Looking to contribute something to java_basics? 
...
The [issue tracker](https://github.com/wasulabenjamin/java_basics/issues) is the preferred channel for 
[bug reports](https://github.com/wasulabenjamin/java_basics/issues/new?template=bug_report.md) and 
[features requests](https://github.com/wasulabenjamin/java_basics/issues/new?template=feature_request.md&labels=feature) 
...
[java_basics labels page](https://github.com/wasulabenjamin/java_basics/labels).
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git remote add upstream https://github.com/wasulabenjamin/java_basics.git
   ```
...
## License
By contributing your code, you agree to license your contribution under the [MIT License](https://github.com/wasulabenjamin/java_basics/blob/master/LICENSE).